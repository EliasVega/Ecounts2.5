...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pay_invoice_payment_methods', function (Blueprint $table) {
            $table->id();

            $table->foreignId('pay_invoice_id')->constrained()->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('pay_invoice_payment_methods');
    }
};
