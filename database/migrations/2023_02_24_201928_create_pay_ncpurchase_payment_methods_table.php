...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('pay_ncpurchase_payment_methods', function (Blueprint $table) {
            $table->id();

            $table->decimal('payment', 10,2);
            $table->string('transaction', 20);

            $table->foreignId('pay_ncpurchase_id')->constrained()->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('pay_ncpurchase_payment_methods');
    }
};
