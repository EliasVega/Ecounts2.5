...
<main class="main">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3>Listado de Usuarios  <a href="user/create" class="btn btn-success"><i class="fa fa-plus mr-2"></i> Agregar Usuario</a>
                <a href="{{ route('company.index') }}" class="btn btn-limon"><i class="fas fa-undo-alt mr-2"></i>Regresar</a>
                <a href="{{ route('inactive') }}" class="btn btn-celeste"><i class="fas fa-undo-alt mr-2"></i>Activar Usuario</a>
                <!--
