                ...
                <div class="box-body row">
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="customer_id" class="form-control" value="{{ $order->customer->name }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="form-control-label" for="payment_form_id">Pago</label>
                            <input type="text" name="payment_form_id" class="form-control" value="{{ $order->paymentForm->name }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="form-control-label" for="payment_method_id">Medio</label>
                            <input type="text" name="payment_method_id" class="form-control" value="{{ $order->paymentMethod->name }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="form-control-label" for="due_date">Vencimiento</label>
                            <input type="date" name="due_date" class="form-control" value="{{ $order->due_date }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="total_iva" id="total_iva" class="form-control" value="{{ $order->total_iva }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="form-control-label" for="total_pay"></label>
                            <input type="text" name="total_pay" id="total_pay" class="form-control" value="{{ $order->total_pay }}" readonly>
                        </div>
                    </div>
                            ...
                            <table class="table table-striped table-bordered table-condensed table-hover">
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        ...
                                        <th><p align="right">${{ $order->total }}</p></th>
                                    </tr>

                                    <tr>
                                        <th colspan="3"><p align="right">TOTAL IVA:</p></th>
                                        <th><p align="right">${{ $order->total_iva }}</p></th>
                                    </tr>

                                    <tr>
                                        <th  colspan="3"><p align="right">TOTAL PAGAR:</p></th>
                                        <th><p align="right">${{ $order->total_pay }}</p></th>
                                    </tr>
                                ...
                                <tbody>
                                    @foreach($orderProducts as $orderProduct)
                                        <tr>
                                            ...
                                            <td class="tdder">${{ $orderProduct->price }}</td>
                                            <td class="tdder">{{ $orderProduct->quantity }}</td>
                                            <td class="tdder">{{ $orderProduct->subtotal }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
