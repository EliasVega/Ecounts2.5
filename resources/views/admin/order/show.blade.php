    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                <h6>{{ number_format($order->balance, 2) }}</h6>
            </div>
        </div>
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
            <div class="form-group">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="form-group">
                    <h3>Detalle de la Compra
                        <a href="{{ route('order.index') }}" class="btn btn-gris"><i class="fas fa-undo-alt mr-2"></i>Regresar</a></h3>
                </div>
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <tbody>
                            @foreach($orderProducts as $orderProduct)
                                <tr>
                                    ...
                                    <td class="tdder">{{ number_format($orderProduct->subtotal,2) }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
