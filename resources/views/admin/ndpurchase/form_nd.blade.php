<div class="box-body row">
    ...
    <div class="col-lg-3 col-md-2 col-sm-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="number" id="pay" name="stock" value="{{ $purchases->pay }}" class="form-control" placeholder="Abono"
                disabled pattern="[0-9]{0,15}">
        </div>
    </div>
    <div class="col-lg-3 col-md-2 col-sm-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="number" id="balance" name="balance" value="{{ $purchases->balance }}" class="form-control" placeholder="Saldo" disabled pattern="[0-9]{0,15}">
        </div>
    </div>
