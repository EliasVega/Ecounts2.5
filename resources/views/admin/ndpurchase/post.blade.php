            ...
            <table class="tabla">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="footder"><strong>${{number_format($ndpurchase->total,2)}}</strong></td>
                    </tr>

                    <tr>
                        <th colspan="3" class="footder">TOTAL IVA:</th>
                        <td colspan="3" class="footder"><strong>${{number_format($ndpurchase->total_iva,2)}}</strong> </td>
                    </tr>

                    <tr>
                        <th  colspan="3" class="footder">TOTAL PAGAR:</th>
                        <td colspan="3" class="footder"><strong>${{number_format($ndpurchase->total_pay,2)}}</strong></td>
                    </tr>
                    @if ($ndpurchase->pay > 0)
                        <tr>
                            <th  colspan="3" class="footder">ABONOS:</th>
                            <td colspan="3" class="footder"><strong>${{number_format($ndpurchase->pay,2)}}</strong></td>
                        </tr>
                        <tr>
                            <th  colspan="3" class="footder">SALDO:</th>
                            <td colspan="3" class="footder"><strong>${{number_format($ndpurchase->balance,2)}}</strong></td>
                        </tr>
                    @endif
                </tfoot>
            </table>
