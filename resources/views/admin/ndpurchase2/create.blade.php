    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box-danger">
            <div class="box-header with-border">
                <h4 class="box-title">Agregar Nota Debito Compra</h4>
            </div>
            @if (count($errors)>0)
            ...
            <div class="box-body row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4 col-xs-12">
                    <div class="form-group">
                        <label class="form-control-label" for="quantityP">Unid/Compradas</label>
                ...
                <div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
                    <div class="form-group">
                        <label class="form-control-label" for="quantity">Devolucion</label>
        ...
        */
        ...
        function add(){
            ...
            if(product_id !="" && quantity!="" && quantity>0 && quantityP != "" && price!="" && stock>"" && iva!=""){
                ...
                if(parseInt(quantity) <= parseInt(quantityP) && parseInt(quantity) > 0){
                ...
                total_iva=total_iva+ivita;
                    ...
                    Swal.fire({
                        type: 'error',
                        //title: 'Oops...',
                        text: 'La cantidad supera las unidades compradas o es negativa',
