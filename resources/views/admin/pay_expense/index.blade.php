    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed table-hover" id="payExpenses">
                    <thead>
                        <tr class="bg-info">
                            <th>ID</th>
                            <th>Comp #</th>
    ...
    $(document).ready(function ()
    {
        $('#payExpenses').DataTable(
        {
            ...
            [
                ...
                {data: 'balance_expense', className: 'dt-body-right', render: $.fn.dataTable.render.number( '.', ',', 2, '$')},
                {data: 'created_at'},
                {data: 'btn'},
            ],
