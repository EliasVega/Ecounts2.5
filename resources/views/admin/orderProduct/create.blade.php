        ...
        <div class="box-danger">
            ...
            <form action="{{route('orderProduct.store')}}" method="POST">
                ...
                <div class="box-body row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="form-control-label" for="totalIva"></label>
                            <input type="text" name="totalIva" id="totalIva" class="form-control" value="{{ $orders->totalIva }}" readonly>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                        <div class="form-group">
                            <label class="form-control-label" for="totalPay"></label>
                            <input type="text" name="totalPay" id="totalPay" class="form-control" value="{{ $orders->totalPay }}" readonly>
                        </div>
                    </div>
