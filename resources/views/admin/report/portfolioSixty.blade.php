...
REPORTE DE CARTERA MAS DE 60 DIAS
@endsection
@section('content')
<main class="main">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3>CARTERA MAYOR A 60 DIAS
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed table-hover" id="portfolioSixty">
                    <thead>
                        <tr class="bg-info">
                            <th>Id</th>
                            <th>Vendedor</th>
...
@push('scripts')
    ...
    {
        $('#portfolioSixty').DataTable({
            responsive: true,
            autoWidth: false,
            processing: true,
            serverSide: true,
            ajax: '{{ route('portfolioSixty') }}',
            columns:
            [
                {data: 'id'},
                {data: 'name'},
