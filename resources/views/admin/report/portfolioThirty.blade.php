...
REPORTE DE CARTERA CON MAS DE TREINTA DIAS
@endsection
@section('content')
<main class="main">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h3>CARTERA + DE 30 DIAS
                <a href="{{ route('portfolio') }}" class="btn btn-limon"><i class="fas fa-undo-alt mr-2"></i>Regresar</a></h3>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="table-responsive">
                <table class="table table-striped table-bordered table-condensed table-hover" id="portfolioThirty">
                    <thead>
                        <tr class="bg-info">
                            <th>Id</th>
                            <th>Vendedor</th>
...
@push('scripts')
    ...
    {
        $('#portfolioThirty').DataTable({
            responsive: true,
            autoWidth: false,
            processing: true,
            serverSide: true,
            ajax: '{{ route('portfolioThirty') }}',
            columns:
            [
                {data: 'id'},
                {data: 'name'},
