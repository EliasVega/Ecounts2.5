<div class="box-body row">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="number" id="balance" name="balance" value="{{ $purchase->balance }}" class="form-control gris" disabled pattern="[0-9]{0,15}">
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12" id="paymenty">
        <div class="form-group">
