<div class="box-body row">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="number" value="{{ old('number') }}" class="form-control" placeholder="Numero de identificacion ">
                    </div>
                </div>
                ...
                <div class="col-lg-2 col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="phone" value="{{ old('phone') }}" class="form-control" placeholder="Ingrese el Numero de telefono">
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select name="organization_id" class="form-control selectpicker" data-live-search="true" id="organization" required>
