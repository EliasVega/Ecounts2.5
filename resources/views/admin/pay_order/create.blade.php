...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box-danger">
            ...
            @endif
            <form action="{{route('pay_order.store')}}" method="POST">
                {{csrf_field()}}
                <div class="box-body row">
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="number" value="{{ $orders->id }}" class="form-control" disabled pattern="[0-9]{0,15}">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ $orders->name }}" class="form-control" disabled pattern="[0-9]{0,15}">
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
                        <div class="form-group">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="form-group" id="payEventy">
                            <label for="payEvent_id">Abono de Documento</label>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="form-group">
                            ...
                            <a href="{{url('pay_order')}}" class="btn btn-danger"><i class="fa fa-window-close"></i>&nbsp; Cancelar</a>
                        </div>
                    </div>
