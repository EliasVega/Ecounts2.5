<div class="box-body row">
    ...
    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
        <div class="form-group row">
            ...
            <select name="product_id" class="form-control selectpicker" id="product_id"
                ...
                <option
                    value="{{ $bp->id }}_{{ $bp->stock }}_{{ $bp->salePrice }}_{{ $bp->iva }}_{{ $bp->idP }}">
    ...
    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
        <div class="form-group">
            <label class="form-control-label" for="salePrice">Precio</label>
    ...
    <div class="col-lg-2 col-md-2 col-sm-6 col-xs-12">
        <div class="form-group" id="porcentage">
            <label class="form-control-label" for="porcentage"></label>
            ...
            <table id="details" class="table table-striped table-bordered table-condensed table-hover">
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td class="footder"><strong id="totalIva_html">$ 0.00</strong>
                    ...
                    <tr>
                        ...
                        <td class="footder"><strong id="totalPay_html">$ 0.00</strong>
                            <input type="hidden" name="totalPay" id="totalPay"></td>
                    </tr>
                </tfoot>
                <tbody>
                </tbody>
